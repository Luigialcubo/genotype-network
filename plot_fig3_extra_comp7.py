...
SIM_HETER_G003   = "results/fig3/sims_het_gamma_003_extra_comp7.txt"
...
fig_c_extra_comp7, ax_c = plt.subplots(figsize=(10, 5))
...
plt.tight_layout()
plt.savefig(os.path.join(OUT_DIR, 'fig3c_extra_comp7.png'), dpi=300)
plt.close(fig_c_extra_comp7)
print(" -> Guardada en", os.path.join(OUT_DIR, 'fig3c_extra_comp7.png'))
