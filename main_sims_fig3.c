...
int main(){
    ...
    */
    ...
    if (!A_uni_reticula || !X_uni_reticula) {
    ...
    */
    ...
    /*
    double I_het_gamma_0 = 0.0, I_het_gamma_003 = 0.0, I_hom_gamma_0 = 0.0, I_hom_gamma_003 = 0.0,
    */
    double I_reticula_gamma_0 = 0.0, I_reticula_gamma_003 = 0.0;
    /*
    double t_het_gamma_0 = 0.0, t_het_gamma_003 = 0.0, t_hom_gamma_0 = 0.0, t_hom_gamma_003 = 0.0,
    */
    double t_reticula_gamma_0 = 0.0, t_reticula_gamma_003 = 0.0;
    /*
    int iter_het_gamma_0 = 0, iter_het_gamma_003 = 0, iter_hom_gamma_0 = 0, iter_hom_gamma_003 = 0,
    */
    int iter_reticula_gamma_0 = 0, iter_reticula_gamma_003 = 0;
    int i;
    ...
    */
    ...
    if (sims_reticula_gamma_0 == NULL || sims_reticula_gamma_003 == NULL) {
