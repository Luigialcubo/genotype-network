 ...
 * 
 * Simulación del modelo SIMS para la COMPONENTE 1 de la red de Influenza A.
 * 
 *   - Lee la red desde "componentes_conexas/componente_1.txt".
 *   - Carga la partición de comunidades desde "results/fig4/particion_comp1.txt".
 *   - Integra con RK4 y guarda la prevalencia por comunidad en "results/fig4/sims_comp1.txt".
 *
 * Compilación:
...
int main() {
    ...
    // Archivos específicos de la Componente 1
    ...
    // --- Leer número de nodos de la red ---
    ...
    printf("Componente 1: N=%d, nodo inicial=%d, gamma=%.2f, t_max=%.0f\n",
    ...
    for (int iter = 0; iter < max_iter; iter++) {
        if (iter % guardar_cada == 0) {
            ...
            // Escribir tiempo y prevalencias por comunidad
            fprintf(salida, "%.6f", t);
            for (int i = 0; i < K; i++) {
