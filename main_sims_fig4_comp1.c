 ...
 *
 * Simulación del modelo SIMS para la componente 1.
 *
 * Lee:
 *   - Red:        componentes_conexas_temporales/componente_1_temporal_con_N.txt
 *   - Partición:  results/fig4/particion_comp1.txt
 *
 * Guarda:
 *   - results/fig4/sims_comp1.txt
 *
 * Formato de salida:
...
int main() {
    ...
    const char *archivo_red =
        "componentes_conexas_temporales/componente_1_temporal_con_N.txt";

    const char *archivo_salida =
        "results/fig4/sims_comp1.txt";

    const char *archivo_particion =
        "results/fig4/particion_comp1.txt";
    ...
    printf("========================================\n");
    printf("SIMULACIÓN COMPONENTE 1\n");
    printf("Red: %s\n", archivo_red);
    printf("Partición: %s\n", archivo_particion);
    printf("Salida: %s\n", archivo_salida);
    printf("N = %d\n", N);
