...
*/
    ...
    do{
        ...
        if(contador == 0){
            if(I_het_gamma_003 >= 0.25){
                pa_het_gamma_003.beta = beta_original_het_003 * 0.40;
                contador = 20/dT;
            } else if(I_het_gamma_003 < 0.25 && I_het_gamma_003 >= 0.05){
                pa_het_gamma_003.beta = beta_original_het_003 * 0.90; //mascarillas
            } else {
                pa_het_gamma_003.beta = beta_original_het_003;
            }
        ...
        printf("%d\n", iter_het_gamma_003);
    } while (iter_het_gamma_003 < (200/dT));
/*
    // SIMS hom gamma = 0
    do{
