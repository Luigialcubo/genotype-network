...
Lee los datos de results/fig4/sims_comp1.txt.
Guarda la figura en plots/fig4/fig4_comp1.png
"""
...
I_comunidades = datos[:, 1:]     # columnas de comunidades
...
plt.show()
print(f"Figura guardada en {CARPETA_SALIDA}/fig4_comp1.png")