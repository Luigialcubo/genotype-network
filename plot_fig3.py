...
ax_b.plot(t_lat_g0, I_lat_g0, color=COLOR_LATTICE, lw=2, label='Retícula')
ax_b.plot(t_hom_g0, I_hom_g0, color=COLOR_HOMOG,   lw=2, label='Estrellas homogéneas')
ax_b.plot(t_het_g0, I_het_g0, color=COLOR_HETEROG, lw=2, label='Estrellas heterogéneas')
...
ax_c.plot(t_lat_g03, I_lat_g03, color=COLOR_LATTICE, lw=2, label='Retícula')
ax_c.plot(t_hom_g03, I_hom_g03, color=COLOR_HOMOG,   lw=2, label='Estrellas homogéneas')
ax_c.plot(t_het_g03, I_het_g03, color=COLOR_HETEROG, lw=2, label='Estrellas heterogéneas')
