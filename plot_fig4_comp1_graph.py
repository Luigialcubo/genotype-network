"""
Ejecutar: py plot_fig4_comp1_graph.py
Carga la red de la componente 1 y su partición en comunidades,
y dibuja el grafo con los nodos coloreados según la comunidad.
Guarda la figura en plots/fig4/fig4_comp1_graph.png
"""
...
# 1. RUTAS DE ARCHIVOS
# ============================================================
ARCHIVO_RED       = "componentes_conexas/componente_1.txt"
...
ax.set_title("Componente 1 – Comunidades detectadas")
ax.axis('off')
...
plt.tight_layout()
plt.savefig(os.path.join(CARPETA_SALIDA, 'fig4_comp1_graph.png'), dpi=300)
plt.show()
print(f"Figura guardada en {CARPETA_SALIDA}/fig4_comp1_graph.png")