 ...
 * 
 * Simulación del modelo SIMS para la COMPONENTE 7 de la red de Influenza A.
 * 
 *   - Lee la red desde "componentes_conexas/componente_7.txt".
 *   - Carga la partición de comunidades desde "results/fig4/particion_comp7.txt".
 *   - Integra con RK4 y guarda la prevalencia por comunidad en "results/fig4/sims_comp7.txt".
 *
 * Compilación:
...
int main() {
    ...
    const char *archivo_red      = "componentes_conexas/componente_7.txt";
    const char *archivo_salida   = "results/fig4/sims_comp7.txt";
    ...
    printf("Componente 7: N=%d, nodo inicial=%d, gamma=%.2f, t_max=%.0f\n",
