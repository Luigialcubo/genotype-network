 ...
 * Simula el modelo SIMS solo para la componente 7.
 *
 * Compilar:
...
int main() {
    // Parámetros del modelo (igual que en el paper)
    ParametrosSIMS pa;
    pa.beta  = 0.3;
    pa.mu_0  = 0.1;
    pa.Dx    = 1.0e-5;
    ...
    // Archivos específicos para la componente 7
