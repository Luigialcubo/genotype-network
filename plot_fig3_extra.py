...
SIM_HETER_G003   = "results/fig3/sims_het_gamma_003_extra.txt"
...
plt.tight_layout()
plt.savefig(os.path.join(OUT_DIR, 'fig3c_extra.png'), dpi=300)
plt.close(fig_c_extra)
print(" -> Guardada en", os.path.join(OUT_DIR, 'fig3c_extra.png'))
